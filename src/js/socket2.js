...
function iniciaSockets(position){
	...
	websocket = io.connect('http://'+ip+':6000',{query:'id='+idLocalLS+'&nombre='+nombreLocal+'&edad='+edad+'&sexo='+sexo+'&preferencia='+preferencia+'&temperatura='+temperatura+'&lat='+position.coords.latitude+'&lng='+position.coords.longitude});
